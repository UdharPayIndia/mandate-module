...
internal open class ProductStateMachineFactory(
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        return when {
            ...
            modelClass.isAssignableFrom(ProductOrderDetailSimpleStateMachine::class.java) -> ProductOrderDetailSimpleStateMachine(productUseCase, mandateUseCase, installmentUseCase) as T
